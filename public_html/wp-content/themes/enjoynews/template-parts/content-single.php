...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="breadcrumbs">
		<span class="breadcrumbs-nav">
			...
			<span class="post-category"><?php enjoynews_first_category(); ?></span>
	...
	<div class="entry-content">
		<?php
			the_content( sprintf(
				...
				wp_kses( __( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'enjoynews' ), array( 'span' => array( 'class' => array() ) ) ),
				the_title( '<span class="screen-reader-text">"', '"</span>', false )
			) );

			wp_link_pages( array(
				'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'enjoynews' ),
				'after'  => '</div>',
			) );
		?>
	</div><!-- .entry-content -->
...
<?php
	...
	$args = apply_filters( 'enjoynews_related_posts_args', $query );
	...
	if ( $related->have_posts() ) : $i = 1; ?>
		...
		<div class="entry-related clear">
			<h3><?php esc_html_e('Related Posts', 'enjoynews'); ?></h3>
