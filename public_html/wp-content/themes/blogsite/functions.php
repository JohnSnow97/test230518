...
function blogsite_scripts() {
    ...
    wp_enqueue_script( 'tabslet', get_template_directory_uri() . '/assets/js/jquery.tabslet.js', array(), '20221212', true );	           	
	wp_enqueue_script( 'blogsite-index', get_template_directory_uri() . '/assets/js/index.js', array(), '20221212', true );
	wp_enqueue_script( 'blogsite-custom', get_template_directory_uri() . '/assets/js/jquery.custom.js', array(), '20221212', true );
    ...
    wp_enqueue_style( 'blogsite-style', get_stylesheet_uri(), array(), '20221212' );     
    wp_enqueue_style( 'blogsite-responsive-style',   get_template_directory_uri() . '/responsive.css', array(), '20221212' ); 
